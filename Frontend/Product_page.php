...
<head>
  ...
  <!--
    - custom css link
  -->
  <link rel="stylesheet" href="../assets/css/style-prefix_2.css">
    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <a href="index.php" class="header-logo">
          <img src="../assets/images/logo/logo8.png" alt="Anon's logo" width="175" height="47">
        </a>

        <div class="header-search-container">

        <form action="search_results.php" method="post">
          <input type="text" name="search" class="search-field" placeholder="Enter your product name...">
...
<?php
                  ...
                  $sql = "SELECT * FROM `products_data` WHERE product_code='$pid'";
                  // Execute the SQL query
                  $result = mysqli_query($conn, $sql);
              ...
              <div  class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-banner">
                    <iframe class="vid" width="350" height="480"
                      src="https://www.youtube.com/embed/<?php echo $row['video_code']?>?autoplay=1&mute=1">
                    </iframe>
                  </div>

                  <div class="showcase-content" style="margin-left: 5px; margin-right: 5px;">

                    <div class="saction_1"
                      style="gap: 10px; border: 1px solid rgb(226, 226, 226); padding: 5px; margin-bottom: 10px;">
                      <div class="reviews" style="display: flex; gap: 5px;">
                        <div class="showcase-rating">
                          <ion-icon name="star"></ion-icon>
                          <ion-icon name="star"></ion-icon>
                          <ion-icon name="star"></ion-icon>
                        ...
                        <div style="font-size: small;">(<?php echo $row['Reviews']?> reviews)</div>
                      </div>

                      <a href="#">
                        <h3 class="showcase-title " style="-webkit-line-clamp: 2;display: -webkit-box;line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;"><?php echo $row['Title']?></h3>
                      </a>

                      <p class="showcase-desc" style="-webkit-line-clamp: 2;display: -webkit-box;line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;">
                        <?php echo $row['Derc']?>
                      </p>
                    ...
                    <div class="discount">
                      <h3
                        style="border: 1px solid #ff8f9c; margin-top: 15px; font-size:23px; margin-bottom: 15px; color: #ff8f9c; padding: 5px,5px,5px,5px; width: 150px; text-align: center; background-color: rgb(255, 255, 255);">
                        <strong><?php echo $row['Discount']?></strong> OFF
                      </h3>
                    </div>

                    <div style="border: 1px solid rgb(226, 226, 226); margin-top: 10px;  padding: 5px;"
                      class="price-box">
                      <p style="  color: black; Font-Size 7px; margin-bottom: 0px;"   class="price">&#8377 <?php echo $row['Price']?></p>

                      <del>&#8377 <?php echo $row['Mrp']?></del>
                    </div>

                    <div style="display: flex; gap: 10px; margin-top: 20px;">
                      <button class="add-cart-btn">Add to Favorite</button>
                      <button class="add-cart-btn"> Visit To Amazon</button>
                    </div>


                    <div class="image-box"
                      style="display: flex;scrollbar-width: none; overflow: auto; gap: 10px; margin-top: 10px;">

<?php
                 
                  
                  $sql = "SELECT * FROM `products_data` ORDER BY RAND() Limit 5 ";
                  // Execute the SQL query
                  $result = mysqli_query($conn, $sql);
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      <img src="../assets/images/Product_images/<?php echo $row["video_code"]?>.jpg" alt="Mens Winter Leathers Jackets" width="100px"
                        height="150px" class="product-img default">
                  ...
                  ?>
                    ...
                    <div>
                      <!-- <h2 class="title" style="margin-bottom: 0px; margin-top: 10px;">Advtisment...</h2> -->
                      <!-- <div
                        style="border: 1px solid rgb(226, 226, 226); margin-top: 0px; margin-bottom: 20px; height: 90px;"
                        class="ad">

                        <img src="./assets/images/products/ads.jpg" alt="Mens Winter Leathers Jackets" width="100%"
                        height="90px" class="product-img default">
           ...
           -->
            ...
            <div class="product-main">
              ...
              <h2 style="margin-top: 10px;" class="title">More Products...</h2>
