          ...
          <div class="product-main">
            ...
            <div class="product-grid">
              ...
              ini_set('display_errors', '0');
                ...
                //  if(isset($_POST["search_data"]) && isset($_GET["search"])){

                  $search_data = $_POST["search_data"];

                  $search_brand_string = $_GET["search"];
                  
                

                  if($search_brand_string != "null" ){
                    $sql = "SELECT * FROM `products_data` where Title LIKE '%$search_brand_string%'";
                  }
                 
                  
                  else if($search_brand_string == "null" && $search_data != "null" ){
                    $sql = "SELECT * FROM `products_data` where Title LIKE '%$search_data%'";
                  }
